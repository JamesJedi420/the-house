...
### Added
- Added SAVE_VERSION schema guard for localStorage saves.
- Prevents loading incompatible saves after refactors.
- On mismatch, load fails with console warning and game falls back to a clean start.
